...
var x = setInterval(function () {
	...
	if (distance < 0) {
		...
		// Set the innerHTML of the "countdown-box" element with only the birthday animation
		...
		// Optionally, you can clear the text content of the ".title" element
...
countdownBox.addEventListener("mousemove", function (e) {
	mx = e.pageX;
	my = e.pageY;
});
...
countdownBox.addEventListener("mouseup", function (e) {
	e.preventDefault();
	mousedown = false;
});
